pipeline {
    ...
    environment {
            ...
            ECR_PATH = '203437743805.dkr.ecr.ap-northeast-2.amazonaws.com'
            IMAGE_NAME = '203437743805.dkr.ecr.ap-northeast-2.amazonaws.com/board'
            DEPLOY_Host="15.164.213.101"
        }
    stages {
